...
// console.log("hotAirData",hotAirData)
    ...
    const cancelNormalBetHandler = async () => {
        ...
        // console.log("pYLOAD", `${baseUrlUsaWin}api/aviator_bet_cancel?userid=${userId}&number=1&gamesno=${sr}`)
        try {
            const res = await axios.get(`${baseUrlUsaWin}/userapi/aviator_bet_cancel?userid=${userId}&number=1&gamesno=${sr}`)
            // toast.success(res?.data?.message)
