                    ...
                    <div className="grid grid-cols-[auto_1fr] items-stretch px-0 bg-[#1a253a] rounded ">
                      ...
                      >
                        {selectedMarket.headers.map((headerKey, index) => (
                          <div
                            key={headerKey}
                            className="bg-bg6 bg-[#66666633] text-transparent px-[7px] py-[10px] text-center text-xsm min-h-[55px] 
                               flex items-center justify-center cursor-pointer transition-colors duration-200 ease-in-out border border-black border-t-0 relative"
                          >
                            <div className="odds-value text-[#FFD700]">
                              {match.odds?.[index] ?? ""}
                            </div>
