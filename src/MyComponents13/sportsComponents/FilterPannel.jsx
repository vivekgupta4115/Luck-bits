...
useEffect(() => {
  ...
  return (
    <div className="p-1 pb-4 rounded-lg w-100">
      ...
      {isExpanded && (
        <>
          <div className="bg-[#263045] mt-[-9px]">
            <div className="!m-2  !p-0 w-[95%] h-[2px] border-[#111] bg-mainBg" />
            <div className="grid grid-cols-2 gap-2 w-100 m-2">
              <div className="w-50 bg-[#464F61] rounded-lg mt-2">
                <label className="text-xsm block pt-2 pl-2 text-hederColor2 text-white/40">
                  Start Date
                </label>
                <div className="relative">
                  <input
                    ...
                    className="w-full p-2  pt-0 rounded bg-[#464F61] text-white focus:outline-none  text-xsm"
                  />
                  <CalendarDays
